...
namespace MVAFW.TestItemColls.Android.App.Template
{
    ...
    public class Provision : AppTestItem
    {
        ...
        private int appTest(MyQAPIWS api, AndroidDriver<IWebElement> driver, string logpath)
        {
            ...
            return api.Provision(driver, logpath, UserName, TargetDevice, RouterName, RouterPW, ExplicitWaitSec, BtnOffsetX, BtnOffsetY);
        }
        ...
        public override void doTest()
        {
            ...
            //string key = "provisionResult";
            //eMVACollection.MVAStringCollection[key] = err.ToString();
