...
//	typedef uint  size_t;
    ...
    [DllImport("Gpib-32.dll")]
    public static extern int ibcmd(int ud, string cmd, uint cnt);
    //[DllImport("Gpib-32.dll")]
    //public static extern int ibcmd(int ud, string cmd, int cnt);
    [DllImport("Gpib-32.dll")]
    ...
    [DllImport("Gpib-32.dll")]
    public static extern int ibwrta(int ud, StringBuilder buf, int count);
    [DllImport("Gpib-32.dll")]
